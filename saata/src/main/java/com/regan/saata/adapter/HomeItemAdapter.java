...
public class HomeItemAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener {
    ...
    public HomeItemAdapter(Context context, List<BaseItemInfo> data) {
    ...
    class FuncHolder extends RecyclerView.ViewHolder {
        ...
        private FuncHolder(@NonNull View itemView) {
            super(itemView);
            ivItem = itemView.findViewById(R.id.iv_func);
            tvName = itemView.findViewById(R.id.tv_name);
        }

        private void bind(BaseItemInfo info) {
            ivItem.setImageResource(info.iconSrc);
